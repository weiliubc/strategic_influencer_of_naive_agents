...
This notebook prints out the resulting finite-horizon $K_t$ and $L_t$ for various values of the number of strategic agents $M$, including for approaching the upper limiting case. Periodicity in $K_t$ and $L_t$ begins to occur from $M = 3$ upwards.
